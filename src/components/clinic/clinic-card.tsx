  ...
  return (
    <article className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      <div className="flex flex-col gap-4 md:flex-row">
        <div className="flex h-36 min-w-44 items-center justify-center rounded-md bg-gradient-to-br from-blue-100 via-white to-sky-100 text-sm font-semibold text-blue-900">
          Klinik görseli
        </div>
        <div className="flex-1 space-y-3">
          ...
          <div className="grid gap-2 text-sm text-slate-700 sm:grid-cols-4">
            ...
            <p><strong>İlk muayene:</strong> {clinic.freeInitialExam ? "Ücretsiz" : formatMoney(clinic.firstExamFee)}</p>
          ...
          <div className="flex flex-wrap gap-2">
            <Link href={`/klinikler/${clinic.slug}`} className="rounded-md bg-blue-700 px-3 py-2 text-sm font-semibold text-white">Profili gör</Link>
