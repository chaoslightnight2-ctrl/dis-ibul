      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="rounded bg-emerald-50 px-2 py-1 text-xs font-medium text-emerald-800">Açık kaynak verisi</span>
          </div>
...
<Link
          ...
          className="inline-flex min-h-10 items-center justify-center gap-1 rounded-md bg-blue-700 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-800"
        >
          Kliniği incele <ChevronRight className="h-4 w-4" />
        </Link>
        ...
        <a href={clinic.osmUrl} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 rounded-md border border-slate-200 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
          OpenStreetMap <ExternalLink className="h-4 w-4" />
        </a>
